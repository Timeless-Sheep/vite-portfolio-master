...
const Hobbies = () => {
  const hobbies = [
    {
      title: "Musician",
      text: `I play rythm/lead guitarist in the band "Creepy Clowns" and also play Bass guitar when needed. Jasfel and I have been collaborating for many years; we write original material together and perform when opportunities arise. Although we haven't released official recordings yet due to limited funds, we’re actively preparing demos and plan to publish our music as soon as possible.`,
      image:
